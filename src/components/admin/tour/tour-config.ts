  ...
  steps: [
    {
      ...
      title: 'Filter Status',
      description: 'Filter pesanan berdasarkan status: Semua, Baru (menunggu konfirmasi), Dikonfirmasi, Diproses, Siap (untuk disajikan), atau Selesai. Tab dengan angka menunjukkan jumlah pesanan di status tersebut.',
      position: 'bottom',
    },
    {
      target: '[data-tour="orders-search"]',
      title: 'Cari Pesanan',
      description: 'Ketik nomor pesanan atau nama pelanggan untuk menemukan pesanan dengan cepat.',
      position: 'bottom',
    },
    {
      target: '[data-tour="orders-date-filter"]',
      title: 'Filter Tanggal',
      description: 'Klik "Hari Ini" untuk melihat pesanan hari ini saja, atau pilih rentang tanggal custom untuk melihat pesanan periode tertentu.',
      position: 'bottom',
    },
    {
      target: '[data-tour="orders-list"]',
      title: 'Kartu Pesanan',
      description: 'Setiap kartu menampilkan info pesanan: nomor, meja, total, dan status pembayaran. Klik kartu untuk melihat detail dan mengubah status pesanan (konfirmasi, proses, selesai).',
      position: 'top',
    },
  ],
}
...
export const TOUR_CATEGORIES_PAGE: TourConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Semua kategori ditampilkan di sini berdasarkan abjad. Klik pada kategori untuk melihat atau mengedit. Setiap kategori menampilkan jumlah menu yang ada di dalamnya.',
      position: 'top',
    },
  ],
}
