...
import { MayarPaymentStatus } from '@/components/customer/mayar-payment-status'
  ...
  const { data: order, error: orderError } = await supabase
    ...
    .select(`
      *,
      ...
      payments(id, payment_method, payment_gateway, status, payment_url)
    `)
    .eq('id', orderId)
    ...
    <div className="pb-32">
      ...
      <div className="px-4 -mt-8 space-y-4">
        ...
        {(() => {
          ...
          const isMayar = payment?.payment_gateway === 'mayar' || payment?.payment_method === 'mayar'
