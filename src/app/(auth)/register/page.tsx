    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 px-4 py-8 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white border border-gray-200 text-gray-600 hover:bg-gradient-to-r hover:from-orange-50 hover:to-red-50 hover:border-orange-200 hover:text-orange-600 transition-all duration-300 mb-6 group shadow-sm hover:shadow-md"
          >
